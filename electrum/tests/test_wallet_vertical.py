...
from electrum import storage, softnote, keystore, bip32, slip39, wallet
...
class TestWalletOfflineSigning(TestCaseForTestnet):
    ...
    def test_sending_offline_hd_multisig_online_addr_p2wsh_p2sh(self, mock_save_db):
        ...
        #               this switch is needed to interop with softnote core... https://github.com/softnote/softnote/blob/fba574c908bb61eff1a0e83c935f3526ba9035f2/src/psbt.cpp#L163
