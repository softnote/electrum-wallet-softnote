...
from electrum.softnote import COIN, sha256
...
class TestPeer(TestCaseForTestnet):
    ...
    async def prepare_invoice(
        ...
        amount_sfn = amount_msat/Decimal(COIN*1000)
    ...
    def test_close_upfront_shutdown_script(self):
        ...
        bob_uss_addr = softnote.pubkey_to_address('p2wpkh', bh2u(bob_uss_pub))
        bob_uss = bfh(softnote.address_to_script(bob_uss_addr))
