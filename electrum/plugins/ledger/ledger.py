...
from electrum.softnote import int_to_hex, var_int, is_segwit_script_type, is_b58_address
...
try:
    import hid
    from sfnhip.sfnhipComm import HIDDongleHIDAPI, DongleWait
    from sfnhip.sfnhip import sfnhip
    from sfnhip.sfnhipUtils import compress_public_key,format_transaction, get_regular_input_script, get_p2sh_input_script
    from sfnhip.softnoteTransaction import softnoteTransaction
    from sfnhip.sfnhipFirmwareWizard import checkFirmware, updateFirmware
    from sfnhip.sfnhipException import SFNhipException
    SFNHIP = True
    SFNHIP_DEBUG = False
except ImportError as e:
    if not (isinstance(e, ModuleNotFoundError) and e.name == 'sfnhip'):
        _logger.exception('error importing ledger plugin deps')
    SFNHIP = False

MSG_NEEDS_FW_UPDATE_GENERIC = _('Firmware version too old. Please update at') + \
                      ' https://www.ledgerwallet.com'
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Softnote" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
...
class Ledger_Client(HardwareClientBase):
    def __init__(self, hidDevice, *, product_key: Tuple[int, int],
        ...
        self.dongleObject = sfnhip(hidDevice)
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in Softnote mode")) from e
                raise e
    ...
    def sign_transaction(self, tx, password):
        ...
        for txout in tx.outputs():
            ...
            if not txout.address:
                ...
                # note: max_size based on https://github.com/LedgerHQ/ledger-app-sfn/commit/3a78dee9c0484821df58975803e40d58fbfc2c38#diff-c61ccd96a6d8b54d48f54a3bc4dfa7e2R26
        ...
        try:
            ...
            for utxo in inputs:
                ...
                if segwitTransaction and not client_electrum.supports_segwit_trustedInputs():
                    ...
                    txtmp = softnoteTransaction(bfh(utxo[0]))
...
class LedgerPlugin(HW_PluginBase):
    ...
    client = None
    DEVICE_IDS = [
                   (0x2581, 0x1807), # HW.1 legacy sfnhip
    ...
    @runs_in_hwd_thread
    def get_sfnhip_device(self, device):
        ledger = False
        ...
        return HIDDongleHIDAPI(dev, ledger, SFNHIP_DEBUG)
    ...
    def create_client(self, device, handler):
        ...
        client = self.get_sfnhip_device(device)
