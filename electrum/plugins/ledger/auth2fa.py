...
from sfnhip.sfnhip import SFNhipException

from electrum.gui.qt.util import PasswordLineEdit

from electrum.i18n import _
from electrum import constants, softnote
        ...
        def pin_changed(s):
            if len(s) < len(self.idxs):
                ...
                if not constants.net.TESTNET:
                    ...
                    addr_mainnet = softnote.script_to_address(softnote.address_to_script(addr), net=constants.SoftnoteMainnet)
