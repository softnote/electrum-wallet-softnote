...
from .softnote import (script_to_p2wsh, opcodes, p2wsh_nested_script, push_script,
...
from .softnote import dust_threshold
...
class SwapManager(Logger):
    ...
    def __init__(self, *, wallet: 'Abstract_Wallet', lnworker: 'LNWallet'):
        ...
        # api url
        if constants.net == constants.SoftnoteMainnet:
            self.api_url = API_URL_MAINNET
        elif constants.net == constants.SoftnoteTestnet:
    ...
    async def normal_swap(
        ...
        """send on-chain SFN, receive on Lightning
    ...
    async def get_pairs(self) -> None:
        ...
        limits = pairs['pairs']['SFN/SFN']['limits']
