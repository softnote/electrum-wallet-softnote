...
from .softnote import hash160_to_b58_address, b58_address_to_hash160, TOTAL_COIN_SUPPLY_LIMIT_IN_SFN
...
def shorten_amount(amount):
    """ Given an amount in softnote, shorten it
    """
...
class LnAddr(object):
    def __init__(self, *, paymenthash: bytes = None, amount=None, net: Type[AbstractNet] = None, tags=None, date=None,
        ...
        self._amount = amount  # type: Optional[Decimal]  # in softnotes
    ...
    def amount(self, value):
        ...
        if value.is_nan() or not (0 <= value <= TOTAL_COIN_SUPPLY_LIMIT_IN_SFN):
            raise ValueError(f"amount is out-of-bounds: {value!r} SFN")
        if value * 10**12 % 10:
