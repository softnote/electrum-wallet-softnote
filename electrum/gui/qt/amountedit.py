...
class AmountEdit(SizedFreezableLineEdit):
    ...
    def __init__(self, base_unit, is_int=False, parent=None):
        # This seems sufficient for hundred-SFN amounts with 8 decimals
...
class SFNAmountEdit(AmountEdit):
...
class FeerateEdit(SFNAmountEdit):
    ...
    def get_amount(self):
        sat_per_byte_amount = SFNAmountEdit.get_amount(self)
