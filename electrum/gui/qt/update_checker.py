...
class UpdateCheck(QDialog, Logger):
    url = ""
    download_url = "https://softnote.org/electrumwallet.html#download"
    ...
    def on_retrieval_failed(self):
        self.heading_label.setText('<h2>' + _("Check for updates") + '</h2>')
        url = "<a href='{u}'>{u}</a>".format(u=UpdateCheck.download_url)
        self.detail_label.setText(_("You can see if your version is up to date at this website {}.").format(url))
        self.pb.hide()
