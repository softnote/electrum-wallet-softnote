...
from .amountedit import SFNAmountEdit
...
class SwapDialog(WindowModalDialog):
    ...
    def __init__(self, window: 'ElectrumWindow'):
        ...
        self.send_amount_e = SFNAmountEdit(self.window.get_decimal_point)
        self.recv_amount_e = SFNAmountEdit(self.window.get_decimal_point)
    ...
    def update(self):
        ...
        send_icon = read_QIcon("lightning.png" if self.is_reverse else "softnote.png")
        self.send_label.setIcon(send_icon)
        recv_icon = read_QIcon("lightning.png" if not self.is_reverse else "softnote.png")
