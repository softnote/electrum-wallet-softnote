    ...
    AnchorLayout:
        ...
        BoxLayout:
            ...
            GridLayout:
                ...
                is_fiat: False
                is_max: False
                on_fiat_amount: if self.is_fiat: self.amount = app.fiat_to_sfn(self.fiat_amount)
                on_amount: if not self.is_fiat: self.fiat_amount = app.sfn_to_fiat(self.amount)
                size_hint: 1, None
            ...
            BoxLayout:
                ...
                Button:
                    ...
                    text: _('OK')
                    on_release:
                        root.callback('!' if kb.is_max else sfn.text if kb.amount else '')
                        popup.dismiss()
''')
    ...
    def update_amount(self, c):
        ...
        if c == '<':  # delete
            ...
            try:
                ...
                pass
            # truncate sfn amounts to max precision:
