...
Section
  ...
  ;Links softnote: URI's to Electrum
  WriteRegStr HKCU "Software\Classes\softnote" "" "URL:softnote Protocol"
  WriteRegStr HKCU "Software\Classes\softnote" "URL Protocol" ""
  WriteRegStr HKCU "Software\Classes\softnote" "DefaultIcon" "$\"$INSTDIR\electrum.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\softnote\shell\open\command" "" "$\"$INSTDIR\electrum-${PRODUCT_VERSION}.exe$\" $\"%1$\""
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\softnote"
